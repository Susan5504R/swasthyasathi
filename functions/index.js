...
// This function triggers whenever a new file is uploaded to the Firebase Storage bucket.
exports.onDocumentUpload = functions
  ...
  .onFinalize(async (object) => {
    ...
    // Example path: users/{uid}/documents/{docId}/original.jpg
    ...
    try {
        ...
        const CLOUD_RUN_URL = functions.config().cloudrun?.url || process.env.CLOUD_RUN_URL;
        ...
        console.log(`Triggering processing for uid: ${uid}, docId: ${docId} at ${CLOUD_RUN_URL}/process`);
